...
Route::group(['prefix' => 'series'], function () {
    ...
    Route::get('/create', [SeriesController::class, 'create'])->name('serie_create')->middleware('auth');
    Route::post('/create', [SeriesController::class, 'store'])->name('serie_store')->middleware('auth');
