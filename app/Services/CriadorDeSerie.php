...
class CriadorDeSerie
{
    ...
    public function criar(string $nome, int $quantidadeTemporadas, int $quantidadeEpsodios, ?string $fotoCapa = null): ?Serie
    {
        $serieCriada = null;
        DB::beginTransaction();
        $serie = Serie::create(['nome' => $nome, 'foto_capa' => $fotoCapa]);
